...
function Organizer() {
  return (
    <div className="px-3 mx-auto my-20 max-w-7xl" id="Organizer">
      <div className="">
        <p className="mb-20 text-2xl font-black">برگزار کنندگان </p>
        ...
        <p className="mt-4">
          ...
          می‌رسد و قلم‌ها و اندازه‌بندی‌ها چگونه در نظر گرفته شده‌اس
        </p>
      </div>
    </div>
  );
